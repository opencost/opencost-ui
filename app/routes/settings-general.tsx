        ...
        <div className="px-5 py-5">
          <div className="max-w-[360px]">
            ...
            <p className="mb-3 text-xs text-[#6f6f6f]">
              Used as the default currency when creating new reports and
              dashboards.
            </p>
            <select
      ...
      <section className="overflow-hidden rounded border border-[#e0e0e0] bg-white shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
        ...
        <div className="px-5 py-5">
          ...
          <p className="m-0 mb-4 text-sm text-[#525252]">
            OpenCost is an open-source, vendor-neutral solution for measuring and
            allocating Kubernetes and cloud infrastructure costs in real time.
          </p>
