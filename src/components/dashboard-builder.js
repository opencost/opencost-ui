...
const WIDGET_TYPES = [
  ...
  {
    value: 'external-services-chart',
    label: 'External Services Costs',
    description: 'Third-party service costs',
  },
...
export default function DashboardBuilder({ dashboardId, initialWidgets = [], onSave, onCancel }) {
