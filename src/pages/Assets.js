  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // The Assets API returns an array of results. 
        // When accumulate=true, it's typically an array with one element containing the aggregated assets.
        const assetsData = (response.data && response.data.length > 0) ? response.data[0] : (response.data || {});
